load("HCP_language1.Rdata")
load("HCP_language2.Rdata")
HCP_data = c(HCP_data1,HCP_data2)

# This file is not included in the appendix since we are not able to share it. However, we include the cleaned dataset "HCP_low.npy" and "HCP_high.npy" in the appendix.
library(readxl)
